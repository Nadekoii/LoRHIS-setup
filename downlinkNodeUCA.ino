...
#include <SoftwareSerial.h>   ///////// virtural UART
SoftwareSerial mySerial(7, 9); // RX, TX
// LoRaWAN end-device address (DevAddr)

static const u4_t DEVADDR = 0x01e1773b;

// LoRaWAN NwkSKey, network session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const PROGMEM u1_t NWKSKEY[16] = {  0xBF, 0xD5, 0x43, 0x6E, 0x7A, 0x87, 0x68, 0x84, 0x37, 0xAD, 0x32, 0x27, 0x83, 0x9B, 0xBC, 0x6D };


// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = {0x23, 0x01, 0x19, 0xD7, 0x32, 0x47, 0xCE, 0x96, 0xCF, 0xF8, 0x6E, 0xA9, 0xEC, 0x4C, 0xF1, 0x1E };
    ...
    switch(ev) {
        ...
        case EV_TXCOMPLETE:
            ...
            if (LMIC.dataLen) {
              ...
              // myString = "";
              // strcpy(myString, myled);       //////////// 2 dòng code này làm bị lỗi treo mcu, giới hạn dưới 24byte ......
              Serial.println(myled);
              mySerial.println(myled);
              memset(myled,0,60); 
            }
